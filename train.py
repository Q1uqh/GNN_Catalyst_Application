...
for fold, (tr_idx, va_idx) in enumerate(kfold.split(train_data)):
    ...
    batch_data_val = DataLoader(val_dataset, batch_size=32, shuffle=True, collate_fn=custom_collate_fn)
    batch_data_test = DataLoader(test_data, batch_size=32, shuffle=True, collate_fn=custom_collate_fn)
